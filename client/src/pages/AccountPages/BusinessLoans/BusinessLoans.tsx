        ...
        <div className="max-w-5xl mx-auto px-6 py-10">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-sm max-w-xl mx-auto">
              Whether you're launching a startup or expanding your company, we
          ...
          <div className="mt-16 bg-white p-6 rounded-xl shadow-md flex items-start gap-4">
            ...
            <p className="text-gray-700 text-sm">
              Startups don’t apply for loans – they pitch to investors who fund
              them based on idea potential. Make sure to have a solid business
